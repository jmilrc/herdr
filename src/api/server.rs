...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::AgentEnqueue(_) => "agent.enqueue",
        Method::AgentQueueGet(_) => "agent.queue.get",
        Method::AgentQueueList(_) => "agent.queue.list",
        Method::AgentQueueCancel(_) => "agent.queue.cancel",
        Method::AgentQueueAck(_) => "agent.queue.ack",
